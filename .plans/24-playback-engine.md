...
- Adaptive selection returns at most one live source for later session planning. It does not plan the fallback's encoding, audio or subtitles; a later caller decides those for the session.
