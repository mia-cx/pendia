...
- [ ] Add a bounded random-access reader and Matroska SeekHead/Cues parser. Validate generated start/end Cues fixtures against ffprobe, plus absent and malformed indexes.
