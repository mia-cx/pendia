...
- [ ] From a fresh database, the wizard reaches a scanned library without touching the API by hand.
- [ ] Every admin procedure has a screen, and permission-denied states render.
- [ ] One smoke test drives the wizard.

## TODOs

- [ ] 1. Add the admin service reads and writes the screens need.
...
- [ ] 2. Expose those services as thin procedures on the router.
...
- [ ] 3. Add the web app shell: client, session, errors and the admin layout.
...
- [ ] 7. Add the groups and settings screens.
...
- [ ] 8. Add the wizard smoke test and run the final gate.
