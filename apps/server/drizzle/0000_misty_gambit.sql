...
ALTER TABLE "progress" ADD CONSTRAINT "progress_version_fk" FOREIGN KEY ("version_id","item_id","format") REFERENCES "public"."versions"("id","item_id","format") ON DELETE set null ("version_id") ON UPDATE no action;
