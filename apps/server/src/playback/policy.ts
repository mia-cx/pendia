...
> = {
  ...
  av1: {
    blockSize: 1,
    bounds: [
      [0, 147456, 1_500_000, 4423680, 2048, 1152, 150],
      [1, 278784, 3_000_000, 8363520, 2816, 1584, 150],
      [4, 665856, 6_000_000, 19975680, 4352, 2448, 150],
      [5, 1065024, 10_000_000, 31950720, 5504, 3096, 150],
      [8, 2359296, 12_000_000, 70778880, 6144, 3456, 300],
      [9, 2359296, 20_000_000, 141557760, 6144, 3456, 300],
      [12, 8912896, 30_000_000, 267386880, 8192, 4352, 300],
      [13, 8912896, 40_000_000, 534773760, 8192, 4352, 300],
      [14, 8912896, 60_000_000, 1069547520, 8192, 4352, 300],
      [15, 8912896, 60_000_000, 1069547520, 8192, 4352, 300],
      [16, 35651584, 60_000_000, 1069547520, 16384, 8704, 300],
      [17, 35651584, 100_000_000, 2139095040, 16384, 8704, 300],
      [18, 35651584, 160_000_000, 4278190080, 16384, 8704, 300],
      [19, 35651584, 160_000_000, 4278190080, 16384, 8704, 300],
    ],
  },
};
...
export function outputFrameRateLimit(
  ...
  return bound === undefined
    ? undefined
    : Math.min(Math.floor(bound[3] / (w * h)), bound[6] ?? Infinity);
}
